...
void nextGreater(int arr[], int n) { //given a circular array find the next greater for every element
...
void nextSmaller(int arr[], int n) {  //given a circular array find the next smaller of every element
...
int histogramArea(int arr[], int n) {
	...
	int maxArea = INT_MIN; //why didn't we assign max area to 0??
...
void slidingWindow(int arr[], int n, int k) {
	...
	deque<int> q; //doubly ended queue
